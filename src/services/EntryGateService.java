...
public class EntryGateService {
    ...
    public Ticket createTicket(Gate gate, Vehicle vehicle) throws NoParkingSpotsAvailableException {
//        Step 1: Find an available spot for the vehicle.
        ParkingSpot availableParkingSpot = slotAllocationService.findSpot(vehicle.getVehicleType());
